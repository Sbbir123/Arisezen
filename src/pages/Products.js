          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3 min-h-max">
              <div className="m-2 text-justify text-sm">
                ...
                <p className="text-md font-medium leading-5  md:h-48">
                  Data analytics is the art of extracting insights from
                  information. Imagine sifting through mountains of data to
                  uncover hidden patterns, trends, and relationships. It
                  involves collecting, cleaning, and analyzing data using
                  various tools and techniques like statistics, machine
                  learning, and visualization. Businesses leverage these
                  insights to make informed decisions, optimize operations,
                  predict future trends, and gain a competitive edge.
                </p>
                <div className="flex justify-center my-4">
                  <Link
                    to="/get-demo"
            ...
            <div className="bg-white transition-all ease-in-out duration-400 overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3">
              <div className="m-2 text-justify text-sm">
                ...
                <p className="text-md font-medium leading-5  md:h-48">
                  Network security safeguards your network and data from
                  unauthorized access, misuse, or theft. It's like a digital
                  shield protecting devices, applications, users, and data. It
                  uses various tools like firewalls, encryption, and access
                  controls to create a layered defense. This ensures authorized
                  users access what they need while blocking malicious actors
                  and threats. Effective network security is crucial for
                  businesses to maintain data integrity, prevent downtime, and
            ...
            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3">
              <div className="m-2 text-justify text-sm">
                ...
                <p className="text-md font-medium leading-5  md:h-48">
                  Software development is a service that creates and maintains
                  software applications for your business. Software development
                  can include designing, coding, testing, debugging, and
                  deploying software solutions. Software development helps you
                  automate your business processes, enhance your customer
                  experience, and increase your productivity.
                </p>
                <div className="flex justify-center my-4">
                  <Link
                    to="/get-demo"
            ...
            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3">
              <div className="m-2 text-justify text-sm">
                ...
                <p className="text-md font-medium leading-5  md:h-48">
                  Artificial intelligence is a service that uses advanced
                  algorithms and data to mimic human intelligence and perform
                  tasks that normally require human cognition. Artificial
                  intelligence can include machine learning, natural language
                  processing, computer vision, speech recognition, and chatbots.
                  Artificial intelligence helps you analyze large and complex
                  data, automate repetitive and tedious tasks, improve your
                  customer service, and generate new insights and opportunities.
                </p>
                <div className="flex justify-center my-4">
                  <Link
                    to="/get-demo"
